...
|**jobId** +
__optional__|The ID of the request. This value can be null if request did not run (for example, due to an error). +
...
|**requestTime** +
__optional__|The date and time the request was made. +
