...
Most of the settings provided by this REST API intentionally have minimal documentation.
...
[markdown]
--
An object specifying Index Service settings. You only need to specify the settings you want to change.
--
...
[markdown]
--
Whether page Bloom filter is enabled.
--
...
[markdown]
--
Whether shard affinity is enabled.
--
...
[markdown]
--
The default timeout for the indexer.
An index scan may time out if the query timeout is higher than the indexer timeout.
--
...
[markdown]
--
Number of simultaneous active connections connections in a pool.
--
...
To modify the index batch size, users must have the Full Admin or Cluster Admin role.
--
