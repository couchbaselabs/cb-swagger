The <<put_options-ex-curl-disable>> request disables the creation of new partitions by means of file transfer.
From this point, Search Service index partitions are built on the new nodes assigned to them during rebalance.

The <<put_options-ex-curl-enable>> request re-enables the creation of new partitions by means of file transfer.
