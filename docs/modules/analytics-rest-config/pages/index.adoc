...
:page-toclevels: 2
:page-service-desc: _attachments/_analytics-config.yaml
...
[1]: /cloud/analytics-rest-admin/index.html#restart_node
[2]: /cloud/analytics-rest-admin/index.html#restart_cluster
--
...
[1]: /cloud/analytics-rest-admin/index.html#restart_cluster
--
...
JVM arguments are generally not secure, and are exposed by the [System Event][2] log.
To pass arguments opaquely, you may use [Java command-line argument files][3].

[2]: /cloud/clusters/monitoring/activity-log.html
