...
Specifies the total number of link:/server/8.0/learn/data/transactions.html#active-transaction-record-entries[active transaction records] for all Query nodes in the cluster.
