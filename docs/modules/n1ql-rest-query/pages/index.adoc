...
Each request creates a dedicated memory session.  When a query requires a document or value, memory is allocated from this session based on the size of the document or value. Once the document or value is processed, the allocated memory is returned back to the session, enabling it to be reused by the request. 
...
[section_srh_tlm_n1b]: /server/8.0/n1ql/n1ql-manage/query-settings.html#section_srh_tlm_n1b
...
[auto-execute]: /server/8.0/n1ql/n1ql-language-reference/prepare.html#auto-execute
...
[execute]: /server/8.0/n1ql/n1ql-language-reference/execute.html
...
[transactional-scan-consistency]: /server/8.0/n1ql/n1ql-manage/query-settings.html#transactional-scan-consistency
...
[flex-indexes]: /server/8.0/n1ql/n1ql-language-reference/flex-indexes.html
