...
.Response 400
====
[#get_service-ex-response-400-sql-error]
.SQL++ Error
[source,json]
----
{
...
[#get_service-ex-response-400-request-error]
.Request Error
[source,json]
----
{
...
.Response 400
====
[#post_service-ex-response-400-sql-error]
.SQL++ Error
[source,json]
----
{
...
[#post_service-ex-response-400-request-error]
.Request Error
[source,json]
----
{
