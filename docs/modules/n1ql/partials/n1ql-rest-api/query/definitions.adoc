...
Refer to link:/server/8.0/n1ql/n1ql-manage/query-settings.html#section_srh_tlm_n1b[Named Parameters and Positional Parameters] for details. +
**Example** : `[ "LAX", 6 ]`|< object > array
|**atrcollection** +
__optional__|[#atrcollection_req]
Specifies the collection where the link:/server/8.0/learn/data/transactions.html#active-transaction-record-entries[active transaction record] (ATR) is stored.
...
Refer to link:/server/8.0/n1ql/n1ql-language-reference/prepare.html#auto-execute[Auto-Execute] for more information. +
**Default** : `false` +
...
The level of link:/server/8.0/learn/data/durability.html[durability] for mutations produced by the request.
...
Refer to link:/server/8.0/n1ql/n1ql-language-reference/execute.html[EXECUTE] for examples.
...
Refer to link:/server/8.0/n1ql/n1ql-manage/query-settings.html#transactional-scan-consistency[Transactional Scan Consistency] for details. +
**Default** : `"not_bounded"` +
...
Refer to link:/server/8.0/n1ql/n1ql-language-reference/flex-indexes.html[Flex Indexes] for more information. +
**Default** : `false` +
**Example** : `true`|boolean
|**use_replica** +
...
Refer to link:/server/8.0/n1ql/n1ql-manage/query-settings.html#section_srh_tlm_n1b[Named Parameters and Positional Parameters] for details.|string (any JSON value)
|===
