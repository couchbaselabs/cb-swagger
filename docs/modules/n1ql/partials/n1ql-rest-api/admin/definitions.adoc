...
Specifies the collection where link:/server/8.0/learn/data/transactions.html#active-transaction-record-entries[active transaction records] are stored.
...
Refer to link:/server/8.0/n1ql/n1ql-language-reference/prepare.html#auto-prepare[Auto-Prepare] for more information. +
**Default** : `false` +
...
Specifies how frequently the Query service checks its subset of link:/server/8.0/learn/data/transactions.html#active-transaction-record-entries[active transaction records] for cleanup.
...
Refer to link:/server/8.0/manage/monitor/monitoring-n1ql-query.html#sys-completed-config[Configure the Completed Requests] for more information and examples. +
**Example** : `{
  "user" : "marco",
  "error" : 12003
...
Refer to link:/server/8.0/manage/monitor/monitoring-n1ql-query.html#sys-completed-config[Configure the Completed Requests] for more information.
...
Refer to link:/server/8.0/n1ql/n1ql-language-reference/index-partitioning.html#max-parallelism[Max Parallelism] for more information. +
**Default** : `1` +
...
Specifies the total number of link:/server/8.0/learn/data/transactions.html#active-transaction-record-entries[active transaction records].
...
Refer to link:/server/8.0/manage/monitor/monitoring-n1ql-query.html#monitor-profile-details[Monitoring and Profiling Details] for more information and examples.
