...
Refer to link:/capella/n1ql/n1ql-manage/monitoring-n1ql-query.html#sys-completed-config[Configure the Completed Requests] for more information and examples. +
**Example** : `{
  "user" : "marco",
  "error" : 12003
...
Refer to link:/capella/n1ql/n1ql-manage/monitoring-n1ql-query.html#sys-completed-config[Configure the Completed Requests] for more information.
...
Refer to link:/capella/n1ql/n1ql-manage/monitoring-n1ql-query.html#monitor-profile-details[Monitoring and Profiling Details] for more information and examples.
