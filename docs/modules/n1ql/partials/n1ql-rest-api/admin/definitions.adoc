...
Specifies the collection where link:/server/7.7/learn/data/transactions.html#active-transaction-record-entries[active transaction records] are stored.
...
Refer to link:/server/7.7/n1ql/n1ql-language-reference/prepare.html#auto-prepare[Auto-Prepare] for more information. +
**Default** : `false` +
...
Refer to link:/server/7.7/manage/monitor/monitoring-n1ql-query.html#monitor-profile-details[Monitoring and Profiling Details] for more information and examples.
