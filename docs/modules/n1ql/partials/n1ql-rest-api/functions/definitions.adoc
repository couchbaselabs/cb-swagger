...
**Example** : `"math"`|string
|**bucket** +
__required__|For scope libraries, the bucket in which the library is stored. For global libraries, this string is empty. +
**Example** : `"travel-sample"`|string
|**scope** +
__required__|For scope libraries, the scope in which the library is stored. For global libraries, this string is empty. +
